            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                    '<div class="range_inputs">' +
                        '<button class="applyBtn btn btn-xs btn-primary rounded-pill" disabled="disabled" type="button"></button> ' +
                        '<button class="cancelBtn btn btn-xs btn-light rounded-pill mt-2" type="button"></button>' +
                    '</div>' +
                '</div>' +
            '</div>';
